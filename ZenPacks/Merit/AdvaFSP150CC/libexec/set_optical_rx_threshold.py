...
for component in device.getMonitoredComponents():
    ...
    if component.__class__.__name__ == 'FSP150NetPort':
        opr_dp = 'cmEthernetNetPortStatsOPR_cmEthernetNetPortStatsOPR'
        scale = 1
    else:
        opr_dp = 'Optical input power_Optical input power'
        scale = 10
...
#    current = component.getRRDValue('Optical input power_Optical input power')o
    rrdfile = os.environ['ZENHOME'] + '/perf/' +component.getRRDFileName(opr_dp)
